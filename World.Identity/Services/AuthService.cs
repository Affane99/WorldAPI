...
using World.Application.Contracts.Identity;
using World.Application.Models.Identity;
using World.Identity.Models;

namespace World.Identity.Services
{
    public class AuthService : IAuthService
    {
        ...
        private async Task<JwtSecurityToken> GenerateToken(ApplicationUser user)
        {
            ...
            var signinCreadentials = new SigningCredentials(symmetricSecurityKey, SecurityAlgorithms.HmacSha256);
